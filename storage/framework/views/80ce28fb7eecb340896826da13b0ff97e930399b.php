...
<main class="main oh" id="main">
    ...
    <?php echo $__env->yieldContent('training'); ?>
                ...
                <div class="row">
                    <div class="col-lg-5 order-lg-5 text-right text-md-center" style="padding: 0">
                        <div class="widget widget_nav_menu" style="padding-top: 8px">
                            <ul>
                                <li><a href="<?php echo e(url('/')); ?>">Новости</a></li>
                                <li><a href="<?php echo e(url('/about')); ?>">О федерации</a></li>
                                <li><a href="<?php echo e(url("/training/")); ?>">Тренировка</a></li>
                                <li><a href="<?php echo e(url("/callback")); ?>">Связаться с нами</a></li>
                            </ul>
                        </div>
                    </div>
...
<script src="<?php echo e(asset("js/twitterFetcher_min.js")); ?>"></script>
<script src="<?php echo e(asset("js/jquery.newsTicker.min.js")); ?>"></script>
